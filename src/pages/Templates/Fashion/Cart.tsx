// src/pages/Templates/Fashion/Cart.tsx
...
const Cart: React.FC = () => {
  // Hooks (always unconditionally at top)
  const {
    purchaseContext,
    storeId,
    storeName,
  ...
  const handleUpdateQuantity = (
    ...
    updateQuantity(itemId, newQty, item.purchaseContext, item.storeId);
  };
  ...
  // Conditional wrapper for marketplace vs store
